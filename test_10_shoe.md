...
| dit_step_4 | 3.2 | 7.93 |  |  |
| vae_decode | 0.4 | 7.94 |  |  |
| generation | 14.5 | 7.93 |  | prompt=An unbranded futuristic running shoe made from white technical mesh with a vivid orange sole, floating above a pale gray studio surface, dramatic softbox lighting, premium product photography, photorealistic., resolution=1024x1024, steps=4, quantize=None, seed=42 |
| save_png | 0.1 | 7.93 | test_10_shoe.png |  |
| total_wall_clock | 16.7 |  |  |  |
...
|---|----------|----------------|------------|-------|------|------|
| 1 | 14.5 | 8.07 | 1024x1024 | 4 | 42 | test_10_shoe.png |
...
| base_model | MageFlow |
| generation_time_seconds | 16.7 |
| created_at | 2026-07-29T18:05:19.971479 |
| image_path | None |
| image_paths | None |
| image_strength | None |
| peak_memory_gib | 8.07 |
