...
| vae_decode | 0.3 | 7.86 |  |  |
| edit | 17.1 | 7.86 |  | prompt=change the shoe to deep burgundy polished leather with a translucent smoke-gray sole and subtle chrome details. Preserve the exact silhouette, panel seams, laces, camera angle, floating pose, lighting, shadows, and background., resolution=1024x1024, steps=4, quantize=None, seed=42 |
| save_png | 0.1 | 7.86 | output/test_10_shoe_edited.png |  |
| total_wall_clock | 20.9 |  |  |  |
...
|---|----------|----------------|------------|-------|------|------|
| 1 | 17.1 | 7.87 | 1024x1024 | 4 | 42 | output/test_10_shoe_edited.png |
...
| base_model | MageFlow |
| generation_time_seconds | 20.9 |
| created_at | 2026-07-30T12:09:16.395985 |
| image_path | test_10_shoe.png |
| image_paths | None |
| image_strength | None |
| peak_memory_gib | 8.71 |
